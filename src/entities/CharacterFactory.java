...
public class CharacterFactory {
    ...
    private final ArrayList<String>  walkSheets     = new ArrayList<>();
    private final ArrayList<int[][]> walkRegions    = new ArrayList<>();
    private final ArrayList<Integer> walkHeights    = new ArrayList<>();
    private final ArrayList<Integer> walkPaddings   = new ArrayList<>();
    private final ArrayList<String>  skill1Sheets   = new ArrayList<>();
    private final ArrayList<int[][]> skill1Regions  = new ArrayList<>();
    private final ArrayList<Integer> skill1Heights  = new ArrayList<>();
    private final ArrayList<Integer> skill1Paddings = new ArrayList<>();
    private final ArrayList<String>  skill2Sheets   = new ArrayList<>();
    private final ArrayList<int[][]> skill2Regions  = new ArrayList<>();
    private final ArrayList<Integer> skill2Heights  = new ArrayList<>();
    private final ArrayList<Integer> skill2Paddings = new ArrayList<>();
    ...
    private void add(String name, String idleGif, String headPath,
        ...
        walkHeights.add(walkH);
        walkPaddings.add(walkPad);
        skill1Sheets.add(sk1Sheet);
        skill1Regions.add(sk1Reg);
        skill1Heights.add(sk1H);
        skill1Paddings.add(sk1Pad);
        skill2Sheets.add(sk2Sheet);
        skill2Regions.add(sk2Reg);
        skill2Heights.add(sk2H);
        skill2Paddings.add(sk2Pad);
    }
    ...
    public Character buildCharacter(int index, Class<?> loader, int screenW, int screenH) {
        ...
        return new Character(
                walkSheets.get(index),   walkRegions.get(index),
                walkHeights.get(index),  charW, charH,
                walkPaddings.get(index), idleGifPaths.get(index),
                skill1Sheets.get(index), skill1Regions.get(index),
                skill1Heights.get(index), skill1Paddings.get(index),
                skill2Sheets.get(index), skill2Regions.get(index),
                skill2Heights.get(index), skill2Paddings.get(index),
                loader);
    }
}